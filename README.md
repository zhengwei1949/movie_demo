...
### 注意事项
- 很多代码看不懂没关系，因为用了一些没有学过的技术点，主要看我们看得懂的地方
- 自己做的时候，不一定非要看别人的代码，可以按自己的思路来做

### 当前项目对代码的优化
- 图片使用的是webP格式，减少了大小
- 当前项目使用的ui组件库是vue-material,使用方式是按需加载(参考src/entry.js)
- 图片进行了懒加载(参考src/components/main/movies.vue) img(v-lazyload="movie.poster")

### 如何理解vuex
- https://github.com/zhengwei1949/vuex_demo
- https://github.com/zhengwei1949/vuex-example